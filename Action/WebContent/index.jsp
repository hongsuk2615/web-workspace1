...
<body>
	...
	<p>
		...
		javascript의 \${자바스크립트 변수}를 쓰고 싶다면 페이지 지시어중 isELIgnored = "true"해주면 됨
	...
	<!-- 
		jsp를 이루는 구성인자
		1. JSP 스크립팅 원소 : JSP페이지 안에서 자바코드를 직접 기술할수 있게하는 기술
		   ex) 선언문, 스크립틀릿, 표현식, 지시어, ...
		
		2. 지시어 : JSP페이지 정보에 대한 내용을 표현한다거나 도다른 페이지를 포함할때 사용
