...
<body>
	...
	<h4>2. JSP 표준 액션태그를 이용한 방식(동적 include 방식 == 런타임시 포함되는 형태)</h4>
	<!-- 
		반드시 시작태그와 종료태그를 같이 써야함.
		단, 시작태그와 종료태그사이에 값이 존재할 필요가 없는 경우 시작태그에 /로 닫아줘야함.	
	 -->
	 <jsp:include page="footer.jsp"/>
	 <br><br>
	 특징 1: include하고 있는 페이지에 선언된 변수를 공유하지않는다.(즉, 동일한 이름의 변수 선언 가능)<br>
	 <% String year = "2023"; %>
